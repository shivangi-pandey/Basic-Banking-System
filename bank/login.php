...
<center><body style="background: url(images/bg.jpg);background-size: 80%">
<h1 class="alert alert-success rounded-0">The SparksFoundation Bank</h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
	<br><h4 class="text-center text-black">Kindly Login Here</h4>
